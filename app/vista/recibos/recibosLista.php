<?php require ('../layouts/header.php'); ?>
    ...
    ?>
<img id="papeles" src="/proyecto-daw/public/img/papeles.jpg" alt="papeles">
<section class="contenedorRecibos">
    <h2>Gestión de recibos</h2>
    <div class="divTrasteros">
       <div class="tarjeta">  
            <h3>Pagos</h3>          
           <p>Podrás ver todos tus pagos de un vistazo.</p>
       </div>
       <div class="tarjeta">
           <h3>Recibos</h3> 
           <p>Podrás ver el recibo del mes o el mes que prefieras.</p>
       </div>
       <div class="tarjeta">
           <h3>Descarga</h3> 
           <p>Descarga e imprime tu recibo.</p>
       </div>
    </div>   
</section>
...
<div class="container">   
    <div class="col-md-12">     
        <form action="" method="get" name="fechas">
            <div class="row align-items-center text-center justify-content-center">
                <div class="col-md-4">
                    ...
                    <input type="date" name="from_date" value="<?php if(isset($_GET['from_date'])){echo $_GET['from_date'];} ?>" class="form-control mb-4" id="from_date">
                </div>
                <div class="col-md-4">
                    <label for=""><b>Hasta el Día</b></label>
                    <input type="date" name="to_date" value="<?php if(isset($_GET['to_date'])){echo $_GET['to_date'];} ?>" class="form-control mb-4" id="to_date">
                </div>
                <div class="col-md-4">
                    <label for=""><b></b></label>
        ...
        <div class="card">
            <div class="card-header h1 text-center"> Lista de Recibos
            </div>
            <div class="p-0">
                        ...
                        <tr>
                            ...
                            <td><?php echo $recibo['formaPago'] ?></td>
                                        ...
                                        echo (isset($_SESSION['usuario']) && isset($_SESSION['rol']) && $_SESSION['rol'] == 1) ?        
                                                '
                                        <td>
                                            <a href="reciboEditar.php?id=' . $recibo['id_recibo'] . '"><img class="ediborra" src="/tutrastero/tutrastero/public/img/editar.ico" alt="Editar"></a>
                                        </td>
                                        <td>
                                            <a href="reciboEditar.php?id=' . $recibo['id_recibo'] . '"><img class="ediborra" src="/tutrastero/tutrastero/public/img/borrar.ico" alt="Eliminar"></a>
                                        </td>
                                        ' : ''; 
                                        ?>
                            <td>
...
<nav aria-label="Page navigation example">
    <ul class="pagination justify-content-center mt-5">
        ...
        <li class="page-item <?php echo $pagina==$i ? 'active' :'' ?>"><a class="page-link" href="recibosLista.php?pagina=<?php echo $i;?>&from_date=<?php echo $fDate;?>&to_date=<?php echo $tDate;?>"><?php echo $i; ?></a>
        </li>
