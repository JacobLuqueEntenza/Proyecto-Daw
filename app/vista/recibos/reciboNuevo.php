                ...
                <div class="form-container mt-5">
                    <form action="" method="POST" class="mt-5" name="nuevoRecibo">
                        ...
                        <div class="form-group"> 
                            ...
                            <input type="text" class="form-control" id="trastero" name="trastero" value="<?php if (isset($id)) { echo $usuario['trastero_id'];}?>">
                        </div>
                        <div class="form-group">                          
                            <input type="hidden" class="form-control" id="pagada" name="pagada" value="<?php if($formaPago === NULL){ echo $pagada = 0; } ?>">
                        </div>
                        <div class="form-group">
                            <label class="label-grande" for="name">Nombre:</label>
                            <input type="text" class="form-control" id="nombre" name="nombre" value="<?php if (isset($id)) { echo $usuario['nombre'] . ' ' .$usuario['apellido_1'] . ' ' . $usuario['apellido_2']; } ?>">
                        </div>                        
                        <div class="form-group">
                        ...
                        <button type="submit" class="btn btn-success mt-3" value="agregarRecibo" name="agregarRecibo">Añadir Recibo</button>
                    </form>
                </div>
            </div> 
        </div> 
