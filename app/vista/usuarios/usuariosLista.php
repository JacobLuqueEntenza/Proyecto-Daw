...
?>
        ...
        <nav aria-label="Page navigation example">
            ...
            <?php endif; ?>
                ...
                <li class="page-item <?php echo $pagina==$i ? 'active' :'' ?>"><a class="page-link" href="usuariosLista.php?pagina=<?php echo $i;?>&rolCapturado=<?php echo $rolCapturado;?>&tipoUsers=<?php echo $rolCapturado;?>"><?php echo $i; ?></a>
                </li>
