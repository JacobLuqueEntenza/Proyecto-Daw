                ...
                <table class="table text-center tablaUsuarios" id="tablaUsuarios">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href='averiaEditar.php?id=<?php echo $averia['id_averia'];?>'><img class="ediborra" src="/tutrastero/tutrastero/public/img/editar.ico" alt="Editar"></a>
                            </td>
                            <td>
                                <a href='averiaEditar.php?id=<?php echo $averia['id_averia'];?>'><img class="ediborra" src="/tutrastero/tutrastero/public/img/borrar.ico" alt="Eliminar"></a>
                            </td>
                        </tr>
                        <?php } ?>
                    </tbody>
