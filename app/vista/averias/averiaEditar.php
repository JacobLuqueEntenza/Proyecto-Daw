            ...
            <div class="col-md-6 mt-5">
                <div class="form-container">
                    <form action="" method="POST" class="mt-5" name="nuevoRecibo">
                        <legend class="text-center mt-5 h1">Modificar Aviso Averia</legend>                        
                        ...
                        <button type="submit" class="btn btn-success mt-3" value="actualizar" name="actualizar">Modificar Aviso</button>
                        <button type="submit" class="btn btn-danger mt-3" value="eliminar" name="eliminar">Eliminar Aviso</button>
                    </form>
                </div>
            </div> 
        </div> 
