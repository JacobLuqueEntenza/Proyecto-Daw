        ...
        <div class="col-md-6 mt-5" >
            <div class="form-container ">
                <form action="../../controlador/correoAveria.php" method="POST" class="mt-5" name="nuevo">
                    <legend class="text-center mb-5 mt-5">Nueva Averia</legend>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="estado" name="estado" value="A la Espera Reparación" readonly>
                    </div > 
                    <div class="form-group">
                        ...
                        <?php else:?>
                        <input type="text" class="form-control" id="trastero_id" name="trastero_id" value="<?php echo $_SESSION['trastero'];?>" readonly>
                        <?php endif;?>
                    </div>
